      ...
      <Container className="py-5">
        ...
        {items.length === 0 ? (
          ...
          <div className="text-center py-5 bg-white rounded-4 shadow-sm border">
            ...
            <Button variant="dark" className="rounded-pill px-5 py-3 fw-bold" onClick={() => navigate('/catalogo')}>
          ...
          <Row className="g-4">
            ...
            <Col lg={8}>
              ...
              <Button variant="link" onClick={() => navigate('/catalogo')} className="mt-4 text-decoration-none text-muted d-flex align-items-center gap-2">
            ...
            <Col lg={4}>
              <Card className="border-0 shadow-sm rounded-4 sticky-top" style={{ top: "100px" }}>
                <Card.Body className="p-4">
                  ...
                  <Button variant="dark" className="w-100 rounded-pill py-3 fw-bold mb-3" onClick={() => navigate('/pedidos')}>
