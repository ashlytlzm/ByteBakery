...
import { Container, Row, Col, Card, Button, Form, InputGroup, Modal, Toast, ToastContainer } from "react-bootstrap";
import { Search, ShoppingCart, Star, Lock, Check } from "lucide-react";
      ...
      <ToastContainer position="top-end" className="p-3" style={{ zIndex: 1200 }}>
        <Toast show={showToast} onClose={() => setShowToast(false)} delay={2500} autohide bg="dark">
          <Toast.Body className="text-white d-flex align-items-center gap-2">
            ...
            <span><strong>{toastProduct}</strong> agregado al carrito</span>
          </Toast.Body>
        </Toast>
      </ToastContainer>
    </>
