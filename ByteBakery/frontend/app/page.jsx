...
import { Container, Row, Col, Carousel, Accordion, Button, Form, Collapse, OverlayTrigger, Popover, Modal } from "react-bootstrap";
import { useAuth } from "@/components/auth-context";
import { Volume2, Info, ArrowRight, Star, Lock } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <>
      <Header />
      <main className="d-flex flex-column min-vh-100" style={{ backgroundColor: "#fff" }}>
