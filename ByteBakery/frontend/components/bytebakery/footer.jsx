...
/* Importamos las herramientas necesarias de React y Bootstrap */
import React, { useState } from "react";
import { Container, Row, Col, Modal, Button, Form, InputGroup } from "react-bootstrap";
import { MapPin, Phone, Mail, Instagram, Facebook, Users, Send, Twitter } from "lucide-react";

/* Icono de TikTok personalizado usando SVG */
const TikTokIcon = () => (
        ...
        <Row className="g-4">
          ...
          <Col md={6} lg={4}>
            ...
            <div className="d-flex gap-3 mb-4">
              ...
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-white opacity-75 hover-opacity-100 transition">
                <Twitter size={28} />
              </a>
            ...
            {newsletterDone ? (
              <p className="text-white small mb-0">¡Suscripcion exitosa! Gracias por unirte.</p>
            ) : (
            <Form onSubmit={(e) => { e.preventDefault(); if (newsletterEmail) setNewsletterDone(true); }}>
              <InputGroup>
                <Form.Control
                  type="email"
