...
export default function RegistroPage() {
  ...
  const [serverError, setServerError] = useState(""); // ← error que viene del backend
  ...
  /* Envio del formulario — ahora llama a la API real */
  const handleSubmit = async (e) => {
    ...
    const result = await registro(formData.nombre, formData.correo, formData.password);

    setIsSubmitting(false);

    if (!result.ok) {
      // Mostrar el error que devuelve el servidor (ej: "El email ya está registrado")
