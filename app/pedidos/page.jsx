      ...
      <div className="d-flex align-items-center justify-content-center" style={{ minHeight: "calc(100vh - 72px)" }}>
        <div className="text-center px-4" style={{ maxWidth: "460px" }}>
          ...
          <p className="text-muted mb-4" style={{ lineHeight: "1.7" }}>
            Para realizar un pedido personalizado necesitas iniciar sesión con tu cuenta de <strong>Dulce Élite</strong>.
          </p>
...
export default function PedidosPage() {
  ...
  // While loading auth from localStorage, show nothing (prevents flash)
  if (!isReady) {
    return (
  ...
  // Not logged in → show gate screen (NO redirect, NO flash)
  if (!isAuthenticated) {
    return <AuthGate />;
  }
            ...
            <Form noValidate validated={validated} onSubmit={handleSubmit}>
              <Row>
                <Form.Group as={Col} md="6" className="mb-4">
                  ...
                  <Form.Control required type="text" name="nombre" value={formData.nombre} onChange={handleChange} placeholder="Ej. María Pérez" className="rounded-3" />
